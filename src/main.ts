...
import { FileTreeHighlightSettingTab, FileTreeHighlightSettings, DEFAULT_SETTINGS } from './settings';
...
export default class FileTreeHighlight extends Plugin {
	...
	async onload() {
		...
		this.app.workspace.onLayoutReady(() => {
			setTimeout(() => {
				for (const value of Object.values<HighlightingOption>(this.settings.highlightingOptions)) {
